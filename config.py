...
keys = [
    ...
    #Spawn apps
    Key([mod, "shift"], "b", lazy.spawn("min"), desc="Launch brave"),
    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.GroupBox(hide_unused=False, disable_drag=True,background = "272a46", active = "dba19b", inactive = "655668",
                    this_current_screen_border = "655668", highlight_method = "block",fontsize=20),
                widget.Sep(background = "272a46",),

                #Provides a way to launch and keep track of apps
                widget.Prompt(background = "272a46",foreground="dba19b",cursor_color="dba19b",fontsize=14),
                widget.TaskList(background = "272a46", foreground = "dba19b", border = "655668", unfocused_border = "272a46", highlight_method = "block",padding=4, icon_size=0,fontsize=14),
                widget.Systray(background = "272a46"),

                #Shows CPU performance
                widget.TextBox(text='', background="272a46", foreground="655668", padding=-20, fontsize=100),
                widget.TextBox(text='',foreground="dba19b",background="655668"),
                widget.CPU(foreground="dba19b", background="655668",padding=10,fontsize=14),
                ...
                widget.TextBox(text='', background="745776", foreground="dba19b",padding=-20, fontsize=100),
                widget.LaunchBar(
                    progs=[
...
floating_layout = layout.Floating(float_rules=[
    ...
    *layout.Floating.default_float_rules,
    ...
    Match(title='Krita - Edit Text'),  # GPG key password entry
])
